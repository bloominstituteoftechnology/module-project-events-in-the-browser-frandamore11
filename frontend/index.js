  ...
  document.addEventListener('keydown', evt => {
    ...
    if (isUp) {
      if(targeted.parentElement.previousElementSibling) {
          let idx = Array.from(targeted.parentElement.nextElementSibling.children).indexOf(targeted)
    ...
    else if (isSpaceBar) { // Moved the else if (isSpaceBar) block outside of the previous if-else chain
